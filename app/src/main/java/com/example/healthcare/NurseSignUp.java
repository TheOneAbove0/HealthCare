        ...
        signUpBtn.setOnClickListener(v->{
            ...
            final String emailExpression = "^(([\\w-]+\\.)+[\\w-]+|([a-zA-Z]{1}|[\\w-]{2,}))@"
                ...
                if (getMobileTxt.length() == 10) {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(pNumber, 60L, TimeUnit.SECONDS, NurseSignUp.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                        @Override
                        ...
                        public void onVerificationFailed(@NonNull FirebaseException e) {
                            ...
                            Toast.makeText(NurseSignUp.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }

                        @Override
                        public void onCodeSent(@NonNull String backEndOtp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                            Intent intent = new Intent(NurseSignUp.this, NurseOTP_Verification.class);
