...
public class NurseOTP_Verification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resendBtn.setOnClickListener(v -> {
            PhoneAuthProvider.getInstance().verifyPhoneNumber("+977"+getMobile, 60L, TimeUnit.SECONDS, NurseOTP_Verification.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                @Override
                ...
                public void onVerificationFailed(@NonNull FirebaseException e) {
                    ...
                    Toast.makeText(NurseOTP_Verification.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onCodeSent(@NonNull String newBackEndOtp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                    getBackEndOtp = newBackEndOtp;
                    Toast.makeText(NurseOTP_Verification.this, "OTP send successful", Toast.LENGTH_SHORT).show();
                }
            });
                ...
                FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(NurseOTP_Verification.this, "Enter the Correct OTP", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
